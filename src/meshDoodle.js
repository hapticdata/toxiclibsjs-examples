...
//MeshDoodle shows how to use the new [TriangleMesh](https://github.com/hapticdata/toxiclibsjs/blob/master/lib/toxi/geom/mesh/TriangleMesh.js) class to dynamically
//build a 3D mesh, render it using Processing
...
void setup() {
  size(window.innerWidth,600,OPENGL);
  fill(255,255,255);
  stroke(255,0,0);
}
