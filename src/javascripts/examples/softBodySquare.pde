...
//`toxi.physics2d.VerletParticle2D` particles and make it stable enough to
//avoid total structural deformation by including an inner skeleton.
...
//localize the toxiclibs.js objects you are using
//so your Processing.js sketch has access to them
